...
\zl
(\mex{1}) hows the respective Dutch examples, taken from
\citep{Bouma2003a-u}:\addpages\todostefan{add Dutch examples showing that the adverb may preceded
  the subject. Ditransitives?}
\eal
\ex

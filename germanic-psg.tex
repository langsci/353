...
This chapter heavily draws from \citew[Chapter~2]{MuellerGT-Eng4}, which is an updated translation of
...
be used to analyze these kinds of sentences (see \citew[Chapter~2]{MuellerGT-Eng} exercise~1). Another possible grammar is given in (\mex{1}):

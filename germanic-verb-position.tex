...
derived by movement. The counterproposal by \citet{Haider2000a,Haider2019a} does not suggest that all languages are
...
\subsection{VO derived from OV: \citet{Haider2019a}}

\citet{Haider2000a,Haider2019a}
...
\begin{enumerate}
\item Classify the Germanic languages according to their basic constituent order (SVO, SOV, VSO, \ldots) and V2 given the following orders:
\eal

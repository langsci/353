...
comparison of languages. The framework in which the analyses are couched is called \emph{HPSG
  light}. It is based on Head-Driven Phrase Structure Grammar (HPSG) \citep{ps,ps2} in the specific version that is described in detail in
...
web-page.\footnote{
\url{https://hpsg.hu-berlin.de/Software/Grammix/}, \today.} The appendix of
this book contains a list of sentences that were discussed in the respective chapters of this book
and which are covered by the grammars of the respective languages.\itdopt{This is still missing.} Readers are invited to enter the
sentences into the TRALE system \citep{DKMM2004a-u,Penn2004a-u} that comes with Grammix and inspect the complete AVMs.

The book starts with two introductiory chapters: the first chapter introduces the Germanic languages
...
and the North Germanic languages on the one hand, and German, Dutch and Afrikaans on the other hand. Verbal complexes are dealt with in Chapter~\ref{chap-verbal-complex}, verb
first position (used for question formation) and verb second position (for assertions) are explained
...
that some of the textbooks used examples describing violence against women. Examples like \emph{John
  beats Mary.} or \emph{John hits Mary.} were frequent in the 70ies and 80ies. I know of a paper
...
languages (Icelandic being the exception, \citealp[\page 443]{ZMT85a}). 
...
%Kim Gerdes (German linguist), Kim Wilde (British pop singer).
...
Dutch       & Robin     &                      & Robrecht, Robert\\ %https://nl.wikipedia.org/wiki/Robin_(voornaam)
            & Benedikt \\

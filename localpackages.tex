...
%\usepackage{lastpage,float,tabularx}
...
\usepackage{merkmalstruktur,abbrev,makros.2e,my-xspace,article-ex,additional-langsci-index-shortcuts,
eng-date,my-theorems}

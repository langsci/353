...
navy. According to this ``definition'', Swiss German would not be a language.\itdopt{
  https://de.wikipedia.org/wiki/Motorbootkompanie
} Neither would Yiddish
...
\ili{Gothic} and \ili{Burgundian} and some smaller languages constituted the East Germanic branch, of which only Gothic got passed on.
...
Gothic.\itdopt{% 
Walkden: More likely a team led by him
See Ratkus (2018), https://doi.org/10.1075%2Fnowele.00002.rat
}
 The
...
\itdopt{Walkden:
and some disagree with dividing West Germanic into three subbranches altogether. See Stiles (2013), https://doi.org/10.1075/nowele.66.1.02sti.
}

...
then\itdopt{AZ: when?} the languages diverged.\itdopt{AZ: Say here that there are many written documents.}
...
Both are official languages of Norway and are used in parallel\itdopt{AZ: not clear what that means}. There are about 4,3 million
speakers.
...
Nedderdüütsch; in Standard German: Plattdeutsch or Niederdeutsch; %AZ this is clear as mud: do you
                                %want to say that Dutch is part of low Saxon or as most people do
                                %that low saxon are the dialects of German that are spoken in in the Netherlands? I would say: Nedersaksisch or Low Saxon, a group of dialects spoken in the Netherlands, southern Danmark and northwestern Germany
) and High German (varieties of German spoken south of the Benrath and Uerdingen
isoglosses).\itdopt{Stefan: fix}
%\todostefan{more}
...
\itdopt{AZ: it is not clear to me what the difference is between people that speak a language as a second language and people that have active knowledge of a language}

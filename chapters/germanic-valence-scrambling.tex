...
As a teaser for the section on corrdination consider the example in (\mex{1}), which shows that verb phrases with different adverbials may be coordinated:
\ea

...
interactions with morphology \citep[Section~5.5.1]{MuellerGT-Eng1}.\footnote{%
  ...
  Grammar}, the phrasal approaches had a revival \citep{GJ2004a}. Phrasal approaches are widespread
...
extraction \isi{islands} \parencites[\page 249--250]{Chomsky73a}[\page 76]{Fanselow87a}[\page 35--36]{Grewendorf89a}, that is, nothing can be
...
As a teaser for the section on coordination consider the example in (\mex{1}), which shows that verb phrases with different adverbials may be coordinated:
\ea

...
detail in Section~\ref{sec-subj-properties}. According to Reis' definition, the phrase \emph{der
...
finiteness/non-finiteness distinction into account cannot tease these properties\todostefan{which properties?} apart \citep[Section~3]{HoehleTopo}. In what follows, we will have a look at main and embedded clauses with
...
part in complex formation as well. (\mex{1}) gives a \ili{German} example taken from \textcites*[\page
...
\glt Intended: `because there is still working' 
}
\z
...
As will be discussed in Section~\ref{sec-icelandic-quirky-subj}, \ili{Icelandic} has non-nominative subjects \citep{ZMT85a}, which makes it the most

...
North Germanic &                    & Islandic, Faroese, & Old Nordic \\
               ...
               &                    & Swedish            &\\
West Germanic  & German, Dutch,     & English            & Yiddish, Old High \\
...
\gll Engum         datt í hug,  að   vert  væri að reyna til     að kynnast honum.\footnotemark\\
     no.one.\DAT{} fell to mind that worth was  to try   \PREP{} to know    him\\}{\ili{Icelandic}}
...
German uses the expletive \emph{es} to fill the position before the finite verb, if no other
...
\zl
Without the expletive, the pattern would be like the one in (\mex{0}b). In (\mex{0}b) we have the
...
with other Germanic languages. It contains a good description of the syntactic facts assuming a
version of Government \& Binding theory in the background.\itdopt{in the backgound ist wohl
  doof. Aber as its basis ist falsch, denn da kommt keine GB vor.}
}

...
refers to properties like nominative case \citep{Reis82}, subject-verb-agreement, and control. We will deal with this in more
...
\end{figure}
According to the WALS, Icelandic, Norwegian, Swedish, Danish, and English are SVO
...
Standard German allows for orders in which embedding verbs precede embedded verbs \parencites[\page 63--64]{Bech55a}[\page 180]{dBE83a}:
\ea
...
\z
The order in which the embedding verb precedes the embedded verb is standard in Dutch \citep[\page 159]{dBE83a}. Chapter~\ref{chap-verbal-complex}
provides an analysis of the verbal complex in the Germanic OV languages. The verbal complexes always follow the objects.  
} 

\textcites[\page 15]{Haider2010a}[Section~15.2]{Haider2020a} pointed out two further differences between the Germanic VO and OV languages:
...
North Germanic &                                & \ili{Islandic}, \ili{Faroese}, & Old Nordic\il{Nordic!Old} \\
               &                                & \ili{Norwegian}, \ili{Danish}, & (Old Islandic\il{Icelandic!Old})\\
               &                                & \ili{Swedish}                  &\\
West Germanic  & \ili{German}, \ili{Dutch},     & \ili{English}                  & \ili{Yiddish}, Old English\il{English!Old} \\
               & \ili{Afrikaans}, \ili{Frisian} &                                & Old High German\il{German!Old
                                                                                   High}, \\
\lspbottomrule
\end{tabular}}
...
The\is{V2 language|(} Germanic languages, with the exception of English, are so-called \emph{verb"=second languages} (V2
languages). The V2
...
pronouns that are selected by inherently reflexive verbs (\mex{1}), expletive\is{pronoun!expletive} objects (\mex{2}), and certain modal
...
The V2 order is used in declarative main clauses throughout the Germanic languages (except
English). Some Germanic languages do not permit V2 order in embedded clauses. For a discussion of
...
Modern English \citep{HP86a-ed}, the only known cases are \ili{Estonian} (Finno-Ugric, \citealp[\page 343]{Holmberg2015a}), \ili{Sorbian} \citep[entry~79]{Plank2003b-ed} (a Slavic language), the
Celtic languages \ili{Breton} \citep{BK2000a-u}, \ili{Cornish} \citep*[\page 287]{BTW2007a-u}, and
Middle \ili{Welsh} \citep{Willis1998a-u}, Old French\il{French!Old} \parencites[Section~1.3]{Adams1987a-u}[Section~2.1.2]{Roberts93a-u}[Chapter~2]{Vance97a-u}, Old Spanish\il{Spanish!Old}
...
German allow a freer permutation of arguments. In order not to contaminate the effects by
...
arguments can appear in either order. Hence, it seems justified to assume that the OV languages (German,
...
\zl
Dutch has free order of adverbials as well \parencites[\page 387]{Neeleman94b-u}[\page
4]{Koster99a-u}[Section~6]{Bouma2003a-u}. (\mex{1}) shows the Dutch examples corresponding to
(\mex{0}):
...
As was already mentioned, Afrikaans, Dutch, and German are SOV languages and this is shown in embedded
...
\ea{
I  know that Kim read the book yesterday. \jambox{(English)}
}
\z
...
\z
% Haider2010a:47 Frisian as well
%a. Ik leau [dat hy him wol rêde kin] Frisian 
...
German uses the expletive\is{pronoun!expletive} \emph{es} to fill the position before the finite verb, if no other
...
\largerpage
\noindent
Danish uses the expletive\is{pronoun!expletive} to make it clear that an extraction of a constituent took place 
%\itdopt{AZ: this assumes a lot of analysis that has not been provided yet. Maybe rephrase: Danish uses an expletive in sentences such as ... In Chapter ?? we will show that the language here avoids string vacuous movement.}
...
\largerpage
\noindent
Similarly, Yiddish uses an expletive\is{pronoun!expletive} in embedded interrogatives (\emph{w} + V2) if 
...
part in complex formation as well. (\mex{1}) gives a German example taken from Haider (\citeyear[\page
...
(\mex{0}a) is not a subject. German subjects are always in the nominative. As we will see in Section~\ref{sec-icelandic-quirky-subj},
...
really different from Icelandic dative subjects. So, (\mex{0}a) is a subjectless construction.
...
a special kind of passives in which no element gets promoted to subject. SVO languages like English and
...
impersonal passives: Danish simply inserts an expletive\is{pronoun!expletive|(} pronoun into the subject position:
\eal
...
\glt `because there is working there'
\zl
German does not allow for an expletive\is{pronoun!expletive} subject:
\ea[*]{
...
As we will discuss in Section~\ref{sec-icelandic-quirky-subj}, Icelandic has non-nominative subjects \citep{ZMT85a}, which makes it the most
...
the Germanic languages. \citegen{Haider2010a} book about the syntax of German compares German
with other Germanic languages. It contains a good description of the syntactic facts compatible with

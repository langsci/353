...
%
\z
The grammar has to be combined with a lexicon including lexical items like the ones in (\mex{1}):
\ea
Det $\to$ das\\
Det $\to$ ein\\
\nbar $\to$ Lied\\
...
P $\to$ aus\\
\z
There has to be a lexical entry for every word that is used in one of the trees.
...
[S
       ...
       [{S/NP[\snom]}
         ...
         [{VP/NP[\snom]}
           ...
           [{NP[\sacc]} [Kim;Kim ] ] ] ] ]
\end{forest}}
\caption{Analysis of \emph{hvem det kende Kim} `who knows Kim'}

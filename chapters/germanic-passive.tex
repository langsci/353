...
The\is{subject|(} situation in languages like Danish, English, and German is rather clear. For instance, many
...
Expletives\is{pronoun!expletive} are excluded in German impersonal constructions:
\nocite{MOe2011a}
\ea[*]{
...
For\is{case|(} the analysis of the passive, it is useful to distinguish between structural and lexical
...
constructions. The trick that Danish employs is the insertion of an expletive\is{pronoun!expletive}. I assume that the
...
The analysis of the parallel German sentence in (\mex{1}) is shown in

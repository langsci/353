...
\gll at    der    ikke går   en mand på gaden\\
     that \expl{} not  walks a  man  in street.\textsc{def}\\
\ex 
...
passive participle \emph{zersägt}. Structure sharings are omitted to keep things readable.
...
\begin{forest}
%sm edges
[{\ms[stem]{\phon  & \phonliste{ gesägt }\\[2mm]
            \da    & \sliste{ NP[\str]$_i$ }\\[2mm]
            \argst & \sliste{ }}}
       [{\ms[stem]{
...
verbs that do not govern an object. That is passives like the example in (\ref) and intransitive
...
To complete the picture, I provide the \spr and \comps values for the participles of our
prototypical verbs:
\ea
\label{partizipien-hm}%

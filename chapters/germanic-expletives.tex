...
otherwise SOV clause. (\mex{1}) shows \ili{German} examples:
\eal
\ex 
...
\caption{Constraints of the Interrogative Clause Schema that hold for all Germanic languages}\label{fig-interrogative-clause-schema}
\end{figure}

In addition to the constraints in Figure~\ref{fig-interrogative-clause-schema} constraints on the
right daughter are needed. The order of verbs with respect to their arguments has to be specified.
For example, \ili{German} interrogative clauses are verb

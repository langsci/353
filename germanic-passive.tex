...
\gll Er wird das Buch lesen.\\
     he.\nom{} will  the.\acc{} book read\\\jgerman
...
%%      the.\nom{} father taught his.\acc{} son a.\acc{} new kick\\
...
\gll Peter læser avisen.\\
     Peter reads newspaper.\textsc{def}\\\jdanish
...
\gll weil noch getanzt wurde\\
     because still danced was\\\jgerman
...
\gll Oft var   talað      um   þennan mann.\\
     often was talked about this Mann.\acc.\sg.\mas\\\jicelandic
\ex
...
\gll weil der Mann dem Jungen den Ball schenkt\\
     because the.\nom{} man the.\dat{} boy the.\acc{} ball gives\\\jgerman
...
\gll fordi manden giver drengen bolden\\ 
     because man.\textsc{def} gives boy.\textsc{def} ball.\textsc{def}\\\jdanish
...
\gll Ambáttin var gefin konunginum.\\
     the.maidservant.\nom.\sg{}  was given.\fem.\sg{} the.king.\dat\\
...
%%      the.slave.\nom{} hopes for to be given the.king.\dat\\
...
d.&give      (ditrans): & \liste{ NP[\type{str}], NP[\type{str}], NP[{\it lacc\/}] }\\[2mm]
...
\eal
\ex show, read, meet \jambox{(Englisch)}
\ex zeigen, begegnen, treffen \jambox{(German)}
\ex \jambox{(Danish)}
\ex \jambox{(Islandic)}
\zl
